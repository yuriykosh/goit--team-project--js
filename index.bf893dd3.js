 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Ka)),xt(Wa,qa,"esm2017");u=i("6JpON");var $a=document.querySelector("[data-modal-auth-open]"),Za=document.querySelector("[data-auth-modal-close]"),Qa=document.querySelector("[data-auth-modal]"),eo=document.querySelector(".auth-form"),to=document.querySelector("#signup-btn"),no=document.querySelector("#login-btn"),ro=document.querySelector("#email"),io=document.querySelector("#password"),ao=document.querySelector("#library"),oo=document.querySelector("#login"),so=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:wt(),t=gt(e,"auth");if(t.isInitialized())return t.getImmediate();var n=on(e,{popupRedirectResolver:Ha,persistence:[ji,mi,yi]}),r=ce("authTokenSyncURL");if(r){var i=Xa(r);fi(n,i,(function(){return i(n.currentUser)})),li(n,(function(e){return i(e)}))}var a=se("auth");return a&&gr(n,"http://".concat(a)),n}(It({apiKey:"AIzaSyB6-fYDISnqh-ScGsgFwJJynAD_h-V_Izk",authDomain:"filmoteka-3f258.firebaseapp.com",databaseURL:"https://filmoteka-3f258-default-rtdb.firebaseio.com",projectId:"filmoteka-3f258",storageBucket:"filmoteka-3f258.appspot.com",messagingSenderId:"864575243852",appId:"1:864575243852:web:7f3070c34fb9ee1f3756e9"})),uo="login-sign up",co=JSON.parse(localStorage.getItem(uo))||0;co&&(ao.classList.remove("visually-hidden"),oo.classList.add("is-hidden"));var lo,fo=(lo=e(o)(e(s).mark((function t(){var n,r,i;return e(s).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=ro.value,r=io.value,e.prev=2,e.next=5,t=n,a=r,oi(Ee(so),Br.credential(t,a));case 5:i=e.sent,ho(),u.Notify.success("You are logged in"),co+=1,localStorage.setItem(uo,JSON.stringify(co)),vo(),eo.reset(),location.reload(),console.log(i.user),e.next=20;break;case 16:e.prev=16,e.t0=e.catch(2),e.t0.code==Kt.INVALID_PASSWORD?(u.Notify.failure("Wrong password. Please try again."),eo.reset()):u.Notify.failure("Error: ".concat(e.t0.message)),console.log(e.t0);case 20:case"end":return e.stop()}var t,a}),t,null,[[2,16]])}))),function(){return lo.apply(this,arguments)}),po=function(){var t=e(o)(e(s).mark((function t(){var n,r,i;return e(s).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return n=ro.value,r=io.value,e.prev=2,e.next=5,ui(so,n,r);case 5:i=e.sent,ho(),co+=1,localStorage.setItem(uo,JSON.stringify(co)),console.log(co),u.Notify.success("You are successfully signed in"),eo.reset(),location.reload(),vo(),console.log(i.user),e.next=21;break;case 17:e.prev=17,e.t0=e.catch(2),e.t0.code==Kt.INVALID_PASSWORD?u.Notify.failure("Wrong password. Please try again."):u.Notify.failure("Error: ".concat(e.t0.message)),console.log(e.t0);case 21:case"end":return e.stop()}}),t,null,[[2,17]])})));return function(){return t.apply(this,arguments)}}();function ho(){Qa.classList.remove("is-hidden"),document.addEventListener("keydown",mo)}function vo(){Qa.classList.add("is-hidden"),document.removeEventListener("keydown",mo)}function mo(e){"Escape"===e.code&&vo()}no.addEventListener("click",fo),to.addEventListener("click",po),$a.addEventListener("click",ho),Za.addEventListener("click",vo),i("5xtVg"),i("cLfKh")}();
//# sourceMappingURL=index.bf893dd3.js.map
