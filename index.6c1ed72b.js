 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Na)),ot(xa,Sa,"esm2017");var Ca,Pa=i("6JpON"),La=document.querySelector("[data-auth-modal-close]"),Ma=document.querySelector("[data-auth-modal]"),Ua=document.querySelector(".auth-form"),Fa=document.querySelector("#signup-btn"),Va=document.querySelector("#login-btn"),ja=document.querySelector("#email"),Ha=document.querySelector("#password"),Ba=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:at(),t=Ze(e,"auth");if(t.isInitialized())return t.getImmediate();var r=Ht(e,{popupRedirectResolver:Ea,persistence:[Ii,Qn,ei]}),n=G("authTokenSyncURL");if(n){var i=Da(n);Kn(r,i,(function(){return i(r.currentUser)})),qn(r,(function(e){return i(e)}))}var a=W("auth");return a&&Qr(r,"http://".concat(a)),r}(it({apiKey:"AIzaSyB6-fYDISnqh-ScGsgFwJJynAD_h-V_Izk",authDomain:"filmoteka-3f258.firebaseapp.com",databaseURL:"https://filmoteka-3f258-default-rtdb.firebaseio.com",projectId:"filmoteka-3f258",storageBucket:"filmoteka-3f258.appspot.com",messagingSenderId:"864575243852",appId:"1:864575243852:web:7f3070c34fb9ee1f3756e9"})),Wa=(Ca=e(a)(e(o).mark((function t(){var r,n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=ja.value,n=Ha.value,e.prev=2,e.next=5,t=r,a=n,Bn(se(Ba),wn.credential(t,a));case 5:i=e.sent,Pa.Notify.success("You are logged in"),Ga(),Ua.reset(),console.log(i.user),e.next=16;break;case 12:e.prev=12,e.t0=e.catch(2),e.t0.code==Nt.INVALID_PASSWORD?(Pa.Notify.failure("Wrong password. Please try again."),Ua.reset()):Pa.Notify.failure("Error: ".concat(e.t0.message)),console.log(e.t0);case 16:case"end":return e.stop()}var t,a}),t,null,[[2,12]])}))),function(){return Ca.apply(this,arguments)});Va.addEventListener("click",Wa);var za=function(){var t=e(a)(e(o).mark((function t(){var r,n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=ja.value,n=Ha.value,e.prev=2,e.next=5,zn(Ba,r,n);case 5:i=e.sent,Ga(),Pa.Notify.success("You are successfully signed in"),Ua.reset(),console.log(i.user),e.next=16;break;case 12:e.prev=12,e.t0=e.catch(2),e.t0.code==Nt.INVALID_PASSWORD?Pa.Notify.failure("Wrong password. Please try again."):Pa.Notify.failure("Error: ".concat(e.t0.message)),console.log(e.t0);case 16:case"end":return e.stop()}}),t,null,[[2,12]])})));return function(){return t.apply(this,arguments)}}();function Ga(){Ma.classList.toggle("is-hidden")}Fa.addEventListener("click",za),La.addEventListener("click",Ga)}();
//# sourceMappingURL=index.6c1ed72b.js.map
