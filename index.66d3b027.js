 ...
 * limitations under the License.
 */
function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Na)),ot(xa,Sa,"esm2017");var Ca=i("6JpON"),Pa=document.querySelector("[data-modal-auth-open]"),La=document.querySelector("[data-auth-modal-close]"),Ma=document.querySelector("[data-auth-modal]"),Ua=document.querySelector(".auth-form"),Fa=document.querySelector("#signup-btn"),Va=document.querySelector("#login-btn"),ja=document.querySelector("#email"),Ha=document.querySelector("#password"),Ba=document.querySelector("#library"),Wa=document.querySelector("#login"),za=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:at(),t=Ze(e,"auth");if(t.isInitialized())return t.getImmediate();var r=Ht(e,{popupRedirectResolver:Ea,persistence:[Ii,Qn,ei]}),n=G("authTokenSyncURL");if(n){var i=Da(n);Kn(r,i,(function(){return i(r.currentUser)})),qn(r,(function(e){return i(e)}))}var a=W("auth");return a&&Qr(r,"http://".concat(a)),r}(it({apiKey:"AIzaSyB6-fYDISnqh-ScGsgFwJJynAD_h-V_Izk",authDomain:"filmoteka-3f258.firebaseapp.com",databaseURL:"https://filmoteka-3f258-default-rtdb.firebaseio.com",projectId:"filmoteka-3f258",storageBucket:"filmoteka-3f258.appspot.com",messagingSenderId:"864575243852",appId:"1:864575243852:web:7f3070c34fb9ee1f3756e9"})),Ga="login-sign up",qa=JSON.parse(localStorage.getItem(Ga))||0;qa&&(Ba.classList.remove("visually-hidden"),Wa.classList.add("is-hidden"));var Ka,Ja=(Ka=e(a)(e(o).mark((function t(){var r,n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=ja.value,n=Ha.value,e.prev=2,e.next=5,t=r,a=n,Bn(se(za),wn.credential(t,a));case 5:i=e.sent,Xa(),Ca.Notify.success("You are logged in"),qa+=1,localStorage.setItem(Ga,JSON.stringify(qa)),$a(),Ua.reset(),location.reload(),console.log(i.user),e.next=20;break;case 16:e.prev=16,e.t0=e.catch(2),e.t0.code==Nt.INVALID_PASSWORD?(Ca.Notify.failure("Wrong password. Please try again."),Ua.reset()):Ca.Notify.failure("Error: ".concat(e.t0.message)),console.log(e.t0);case 20:case"end":return e.stop()}var t,a}),t,null,[[2,16]])}))),function(){return Ka.apply(this,arguments)}),Ya=function(){var t=e(a)(e(o).mark((function t(){var r,n,i;return e(o).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return r=ja.value,n=Ha.value,e.prev=2,e.next=5,zn(za,r,n);case 5:i=e.sent,Xa(),qa+=1,localStorage.setItem(Ga,JSON.stringify(qa)),console.log(qa),Ca.Notify.success("You are successfully signed in"),Ua.reset(),location.reload(),$a(),console.log(i.user),e.next=21;break;case 17:e.prev=17,e.t0=e.catch(2),e.t0.code==Nt.INVALID_PASSWORD?Ca.Notify.failure("Wrong password. Please try again."):Ca.Notify.failure("Error: ".concat(e.t0.message)),console.log(e.t0);case 21:case"end":return e.stop()}}),t,null,[[2,17]])})));return function(){return t.apply(this,arguments)}}();function Xa(){Ma.classList.remove("is-hidden"),document.addEventListener("keydown",Qa)}function $a(){Ma.classList.add("is-hidden"),document.removeEventListener("keydown",Qa)}function Qa(e){"Escape"===e.code&&$a()}Va.addEventListener("click",Ja),Fa.addEventListener("click",Ya),Pa.addEventListener("click",Xa),La.addEventListener("click",$a)}();
//# sourceMappingURL=index.66d3b027.js.map
